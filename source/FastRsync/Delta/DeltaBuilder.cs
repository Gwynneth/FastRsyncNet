...
namespace FastRsync.Delta {
    public class DeltaBuilder {
        ...
        public async Task BuildDeltaAsync(Stream newFileStream, ISignatureReader signatureReader, IDeltaWriter deltaWriter, CancellationToken ct = default) {
            ...
            while (true) {
                ...
                var startPosition = newFileStream.Position;
                var read = await newFileStream.ReadAsync(buffer, 0, buffer.Length, ct).ConfigureAwait(false);
                if (read < 0)
                    break;
